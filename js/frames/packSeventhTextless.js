...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//bottom info
	loadBottomInfo({
		top: {text:'Illus: {elemidinfo-artist}', x:0.0614, y:0.9015, width:0.8774, height:0.0281, oneLine:true, size:0.0281, align:'center', shadowX:0.0014, shadowY:0.001, color:'white'},
		wizards: {name:'wizards', text:'{elemidinfo-number}', x:0.1, y:0.9296, width:0.8, height:0.0172, oneLine:true, size:0.0172, align:'center', shadowX:0.0014, shadowY:0.001, color:'white'},
