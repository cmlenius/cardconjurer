...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//bottom info
	loadBottomInfo({
		top: {text:'Illus: {elemidinfo-artist}', x:0.1, y:1892/2100, width:0.8, height:0.0267, oneLine:true, size:0.0267, align:'center', shadowX:0.0021, shadowY:0.0015, color:'#eeeeee'},
		wizards: {name:'wizards', text:'{elemidinfo-number}', x:0.1, y:1953/2100, width:0.8, height:0.0172, oneLine:true, size:0.0172, align:'center', shadowX:0.0014, shadowY:0.001, color:'white'},
